...
public enum TestGame {
    ...
    TestGame() {
        ...
        oldGame.addPlayer("P1", TestCourses.INSTANCE.getCourseChalmers().getTees().get(0), 36.0);
        oldGame.addPlayer("P2", TestCourses.INSTANCE.getCourseChalmers().getTees().get(1), 36.0);
        oldGame.addPlayer("P3", TestCourses.INSTANCE.getCourseChalmers().getTees().get(2), 36.0);
        oldGame.addPlayer("P4", TestCourses.INSTANCE.getCourseChalmers().getTees().get(3), 36.0);
